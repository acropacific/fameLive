...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.imageName}">
            <li class="fieldcontain">
                <span id="imageName-label" class="property-label"><g:message code="user.imageName.label"
                                                                             default="Image Name"/></span>

                <span class="property-value" aria-labelledby="imageName-label"><g:fieldValue bean="${userInstance}"
                                                                                             field="imageName"/></span>

            </li>
        </g:if>

        <g:if test="${userInstance?.fameName}">
            <li class="fieldcontain">
                <span id="fameName-label" class="property-label"><g:message code="user.fameName.label"
                                                                            default="Fame Name"/></span>

                <span class="property-value" aria-labelledby="fameName-label"><g:fieldValue bean="${userInstance}"
                                                                                            field="fameName"/></span>
