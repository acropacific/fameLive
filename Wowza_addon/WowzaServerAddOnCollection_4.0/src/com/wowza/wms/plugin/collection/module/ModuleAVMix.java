...
import com.wowza.wms.plugin.collection.avmix.AVMixer;
...
public class ModuleAVMix extends ModuleBase
{
	...
	public void onAppStart(IApplicationInstance appInstance)
	{
		...
		this.debugLog = appInstance.getProperties().getPropertyBoolean("avMixDebugLog", debugLog);
		if (logger.isDebugEnabled())
			debugLog = true;

		appInstance.addMediaCasterListener(mediaCasterListener);
		this.mixer = new AVMixer(appInstance);
