...
import com.wowza.wms.plugin.collection.analytics.GoogleAnalytics;
...
public class ModuleAnalytics extends ModuleBase
{
...
//		private HashMap<String, String> requestMap;
				...
				while (true)
				{
					...
					else
					{
						...
						try
						{
							...
							if (moduleDebug)
								this.requestLogger.info(MODULE_NAME + " Sleep for " + wowzalyticsDelayForFailedReqeusts + " milliseconds");
							Thread.sleep(wowzalyticsDelayForFailedReqeusts);
						}
	...
	private static long wowzalyticsDelayForFailedReqeusts = 1000;
	...
	static
	{
		...
		if (WMSLoggerFactory.getLogger(ModuleAnalytics.class).isDebugEnabled())
			serverDebug = true;

		wowzalyticsDelayForFailedReqeusts = serverProps.getPropertyInt(PROP_NAME_PREFIX + "DelayForFailedReqeusts", (int)wowzalyticsDelayForFailedReqeusts);
	...
	public void onAppStart(IApplicationInstance appInstance)
	{
		...
		this.moduleDebug = Boolean.valueOf(getPropertyValueStr(PROP_NAME_PREFIX + "Debug"));
		...
		this.googleAnalytics = new GoogleAnalytics(appInstance.getName(), getPropertyValueStr(PROP_NAME_PREFIX + "GACode"), getPropertyValueStr(PROP_NAME_PREFIX + "GADomain"), getPropertyValueStr(PROP_NAME_PREFIX + "GAHost"), getPropertyValueStr(PROP_NAME_PREFIX + "GAPrefix"));
	...
	private String sendStatsToGoogle(String sessionId, String cookieStore, String streamName, String referrerStr, String ipAddress, String eventName, String eventValue)
	{
		...
		if (this.googleAnalytics != null)
		{
			...
			String url = this.googleAnalytics.makeGARequest(streamName, referer, ipAddress, cookieID, eventName, eventValue);
