 ...
 */
package com.wowza.wms.plugin.collection.analytics;
...
public class GoogleAnalytics
{
	...
	public String makeGARequest(String stream, String referrer, String ipaddress, String visitorID, String eventName, String eventType)
	{
		...
		String eventCaller = "http://www.google-analytics.com/__utm.gif?utmdt=" + stream + "&utmt=event&utme=5(" + eventName + "*" + eventType + "*" + stream + ")&utmwv=4.4sh" + "&utmn=" + generateUTMN() + "&utmhn=" + this.gaDomain + "&utmr=" + referrer + "&utmp=%2F" + this.GAPrefix + "%2F"
				+ this.appName + "%2F" + stream + "&utmac=" + this.urchinCode + "&utmcc=__utma%3D999.999.999.999.999.1%3B" + "&utmvid=" + visitorID + "&umtip=" + returnGAIP(ipaddress);
