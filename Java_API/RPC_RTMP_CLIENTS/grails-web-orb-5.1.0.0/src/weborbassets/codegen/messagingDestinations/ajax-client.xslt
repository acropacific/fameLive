...
<xsl:stylesheet version="1.0"
	...
	<head>
		...
		<script language="javascript">
			webORB.defaultRemotingURL = "]]><xsl:value-of select="runtime/data/weborbURL"/><![CDATA[";

			var myConsumer = new Consumer("]]><xsl:value-of select="runtime/data/destinationId"/><![CDATA[", new Async(messageReceived, handleFault));
			var myProducer = new Producer("]]><xsl:value-of select="runtime/data/destinationId"/><![CDATA[");
