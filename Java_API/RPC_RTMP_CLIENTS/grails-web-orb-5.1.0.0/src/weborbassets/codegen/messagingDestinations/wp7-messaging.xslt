    ...
    <folder name="weborb-codegen">
      <folder name="WindowsPhoneMessaging">
        <xsl:if test="runtime/data/fullCode = 'true'">
          <folder path="wp7\WindowsPhoneMessaging\Images" />
          <folder path="wp7\WindowsPhoneMessaging\Properties" />
          <folder name="Bin">
            <file path="../../silverlight/windowsphone/WeborbPhoneClient.dll" hideContent="true"/>
          </folder>
        </xsl:if>
        <file path="wp7\WindowsPhoneMessaging\App.xaml.cs" />
        <file path="wp7\WindowsPhoneMessaging\App.xaml" />
        <file path="wp7\WindowsPhoneMessaging\MainPage.xaml" />
        <file path="wp7\WindowsPhoneMessaging\WebORBURLPage.xaml.cs" />
        <file path="wp7\WindowsPhoneMessaging\WebORBURLPage.xaml" />
...
namespace WindowsPhoneMessagingChat
{
  ...
  {
    public static string WeborbUrl = "<xsl:value-of select="runtime/data/weborbURL"/>"; // Can also change to "rtmpt://localhost:port/root";
    ...
    private void Init()
    {
      _client = new WeborbClient( MainPage.WeborbUrl, "<xsl:value-of select="runtime/data/destinationId"/>" );
