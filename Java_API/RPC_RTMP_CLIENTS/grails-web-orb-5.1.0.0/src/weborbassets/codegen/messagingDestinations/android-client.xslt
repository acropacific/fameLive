...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <folder name="weborb-codegen">
            <xsl:variable name="common_files_path" select="'android/common/'"/>
            <xsl:choose>
                <xsl:when test="runtime/data/fullCode = 'true'">
                    <folder name="Intellij Idea 10">
                        <folder name="MessageClientDemoApp">
                            <xsl:variable name="intellij_idea_files_path"
                                          select="'android/idea/MessageClientDemoApp/'"/>
                    ...
                    <folder name="Eclipse 3.6">
                        <folder name="MessageClientDemoApp">
                            <xsl:variable name="eclipse_files_path" select="'android/eclipse/MessageClientDemoApp/'"/>
...
public class MainActivity extends Activity
{
  ...
  private void readPreferences()
  {
    ...
    weborbUrl = settings.getString( getString( R.string.weborb_endpoint_url ), "</xsl:text>
                <xsl:variable name="url" select="//runtime/data/weborbURL"/>
                <xsl:choose>
  ...
  private class ConnectionThread extends Thread
  {
    ...
    public void run()
    {
      ...
      if( subscription != null )
        ...
        }</xsl:text><xsl:variable name="destinationId" select="runtime/data/destinationId"/><xsl:text>
