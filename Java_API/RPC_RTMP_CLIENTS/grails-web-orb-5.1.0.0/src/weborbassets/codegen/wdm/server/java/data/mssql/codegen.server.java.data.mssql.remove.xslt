...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="codegen.server.java.data.mssql.remove">
    ...
    private final String SqlDelete = "Delete From [<xsl:value-of select="@wdm:Schema" />].[<xsl:value-of select="$table" />] "
