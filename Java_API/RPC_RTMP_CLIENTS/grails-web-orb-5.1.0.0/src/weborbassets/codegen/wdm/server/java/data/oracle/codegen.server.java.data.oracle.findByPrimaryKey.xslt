...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="codegen.server.java.data.oracle.findByPrimaryKey">
    ...
    <xsl:variable name="full-class-name" select="concat($serverNS, '.', codegen:getClassName($table,$schema))"/>
