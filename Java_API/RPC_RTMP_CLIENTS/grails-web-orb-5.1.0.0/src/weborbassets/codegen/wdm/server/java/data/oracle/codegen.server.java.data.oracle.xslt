...
<xsl:stylesheet version="1.0"
  ...
  <xsl:import href="codegen.server.java.data.oracle.create.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.update.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.remove.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.findAll.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.load.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.save.xslt"/>
  <xsl:import href="codegen.server.java.data.oracle.findByPrimaryKey.xslt"/>
  
  <xsl:template name="codegen.server.java.data.oracle.enviroment">
    <xsl:if test="codegen:singleCall('codegen.server.java.data.oracle.enviroment')"></xsl:if>
  ...
  <xsl:template name="codegen.server.java.data.oracle.database">
  ...
  <xsl:template name="codegen.server.java.data.oracle">
    <xsl:variable name="class-name" select="codegen:getClassName(@name, @wdm:Schema)"   />
    ...
    import weborb.data.management.oracle.OracleCommandBuilder;
    ...
    public abstract class _<xsl:value-of select="$class-name"/>DataMapper extends DataMapper
    {
      ...
      <xsl:call-template name="codegen.server.java.data.oracle.create" />
      <xsl:call-template name="codegen.server.java.data.oracle.findByPrimaryKey" />
      <xsl:call-template name="codegen.server.java.data.oracle.load" />
      <xsl:call-template name="codegen.server.java.data.oracle.remove" />
      <xsl:call-template name="codegen.server.java.data.oracle.save" />
      <xsl:call-template name="codegen.server.java.data.oracle.update" />        
    }
