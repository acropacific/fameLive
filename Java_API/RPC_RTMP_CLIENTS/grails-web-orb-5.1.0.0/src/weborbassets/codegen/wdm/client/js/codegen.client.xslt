...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template name="codegen.client">
    <file name="wdm-model.js" override="true"><xsl:call-template name="codegen.client.model"/></file>
    <file name="wdm-model-ext.js" override="true"><xsl:call-template name="codegen.client.model.ext" /></file>
