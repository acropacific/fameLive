...
<xsl:template name="codegen.appmain">
  ...
  ************************************************************************/
  ...
  <xsl:template name="codegen.process.fullproject">
    ...
    <xsl:param name="weborbPath" select="codegen:getWebORBPath()"/>
      <xsl:call-template name="main-vs">
        ...
        <xsl:with-param name="weborbPath" select="$weborbPath"/>
      </xsl:call-template>
...
namespace <xsl:value-of select="@namespace" />
{
  public class <xsl:value-of select="@name"/>Service
  {
    ...
    {
      this.model = model;
      weborbClient = new WeborbClient( endpointURL == null ? "<xsl:value-of select="@endpointURL"/>" : endpointURL, uiControl );
