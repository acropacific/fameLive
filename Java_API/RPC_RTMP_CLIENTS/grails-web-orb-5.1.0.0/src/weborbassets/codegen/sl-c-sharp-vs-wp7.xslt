...
namespace <xsl:value-of select="@namespace" />
{
  public class <xsl:value-of select="@name"/>Service
  {
    ...
    {
      this.model = model;
      weborbClient = new WeborbClient( endpointURL == null ? "<xsl:value-of select="//runtime/@endpointURL"/>" : endpointURL, uiControl );
    }
...
namespace Invoker
{
  public class ServiceLibInfo
  {
    ...
    internal static String WEBORB_URL = "<xsl:value-of select="//runtime/@endpointURL"/>";
  }
}    
  </file>
</xsl:template>        
